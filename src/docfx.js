...
$(function () {
  ...
  //Creates code bloks using highlightjs
  highlight();

  //Wraps every table witghin a topic and adds responsive class
  renderTables();
  renderAlerts();
  ...
  //Converting svg to inline svg to enable svg styling through Css
  //renderLogo();
